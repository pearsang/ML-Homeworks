...
print(f"\tx_new: \t cluster 1 = {round(new_posterior['pi_1'], 2)} \t cluster 2 = {round(new_posterior['pi_2'], 2)}\n")
...
print("\tPosteriores:")
for index, posterior in enumerate(posteriores):
    print(f"\tx{index}: \t cluster 1 = {round(posterior['pi_1'], 2)} \t cluster 2 = {round(posterior['pi_2'], 2)}", end="")
...
distances_cluster_1 = pairwise_distances(cluster_1, metric="manhattan")
distances_cluster_2 = pairwise_distances(cluster_2, metric="manhattan")
distances_between_clusters = pairwise_distances(cluster_1, cluster_2, metric="manhattan")

a_cluster_1 = np.mean(distances_cluster_1)
a_cluster_2 = np.mean(distances_cluster_2)
b = np.mean(distances_between_clusters)

silhouette_1 = calculate_silhouette(a_cluster_1, b)
silhouette_2 = calculate_silhouette(a_cluster_2, b)

print(f"\tSilhouette cluster 1 = {silhouette_1}")
print(f"\tSilhouette cluster 2 = {silhouette_2}")
